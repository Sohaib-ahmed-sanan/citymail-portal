...
@section('content')
    ...
    <div class="modal fade" id="chat_modal" role="dialog" aria-labelledby="chatModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered w-800" role="document">
            <div class="modal-content">
                <div class="card card-box">
                    <div class="card-header">
                        <div class="card-header--title">
                            <small>Messenger : <span class="cn_no"></span></small>
                        </div>
                    ...
                    <div class="card-body p-0">
                        <div class="scroll-area-md">
                            <div class="scrollbar-container chat-wrapper p-3 ps">
                                <div id="appendcn"><input type="hidden" id="get_consigment_no" value=""></div>
                                <div id="appendMessages">
                    ...
                    <div class="card-footer bg-light p-4">
                        <div class="">
                            <input class="form-control" id="getMessage"
                                placeholder="Write your message and hit enter to send...">
                            <div class="align-box-row mt-3">
                                <div class="ml-auto">
                                    <a href="javascript:;" id="sendMessage" onclick="sendMessage();"
                                        class="btn btn-orio">
                                        Send
                                    </a>
                                </div>
            ...
            <div class="pb-4 text-center text-xl-left">
                <div class="row align-items-center">
                    <div class="col-xl-6">
                        <div>
                            <ol class="d-inline-block breadcrumb text-uppercase font-size-xs p-0">
                                ...
                                <li class="d-inline-block breadcrumb-item"><a href="javascript::void(0)">Operations</a>
                                </li>
                    ...
                    <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                        <div class="row d-flex gap-5 mx-auto mx-xl-0 mt-3 btn-wrapper">
                            <div class="col-md-2">
                                <button class="btn btn-sm btn-custom" data-toggle="modal" data-target="#filter_modal">
                                    <svg class="w-20" width="28" height="26" viewBox="0 0 28 26"
                                    ...
                                    <div class="col-lg-12 p-4">
                                        <div class="table-tab-content-wrapper">
                                            <ul class="nav nav-line nav-line-alt" id="myTab2" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link tabs-links text-uppercase font-size-xs active"
                                                        id="return-request-tab" data-toggle="tab" href="#return-request"
                                                        role="tab" aria-controls="return-request"
                                                        aria-selected="true">
                                                        Return Requests
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link tabs-links text-uppercase font-size-xs"
                                                        id="returns-tab" data-toggle="tab" href="#returns"
                                                        role="tab" aria-controls="returns" aria-selected="false">
                                                        Returns<span class="badge rounded-pill bg-danger text-white d-none"
                                                            id="error_count"></span>
                                                        <div class="divider"></div>
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content p-0 pt-3">
                                                <div class="tab-pane fade active show" id="return-request"
                                                    role="tabpanel" aria-labelledby="return-request-tab">
                                                    <div id="append_btn_div" class="d-none">
                                                        <div class="btn-group btn-group-split px-2 py-3"
                                                            id="append_btn_div">
                                                            <div id="create-btn-div"
                                                                class="icn-container float-left pl-4">
                                                                <div class="hover-icon" id="hover-icon-1-584">
                                                                    @if (session('is_loadsheet') == 1)
                                                                        <a href="javascript:void(0);"
                                                                            id="generate_loadSheet"
                                                                            class="btn btn-sm btn-secondary-sm mr-2 "
                                                                            style="background-color: #e4e6eb"
                                                                            data-toggle="tooltip"
                                                                            data-original-title="Generate LoadSheet"><i
                                                                                class="fa-solid fa-sheet-plastic"></i></a>
                                                                    @endif
                                                                    <a href="javascript:void(0);" id="print_airway"
                                                                        class="btn btn-sm btn-secondary-sm mr-2 "
                                                                        style="background-color: #e4e6eb"
                                                                        data-toggle="tooltip"
                                                                        data-original-title="Print Bulk AirwayBills"><i
                                                                            class="fas fa-print"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <table id="return_request" class="display nowrap table table-hover"
                                                        width="100%">
                                                        <thead class="thead">
                                                            <tr>
                                                                <th>
                                                ...
                                                <div class="tab-pane fade" id="returns" role="tabpanel"
                                                    ...
                                                    <table id="return"
                                                        class="example2 display nowrap table table-hover" width="100%">
                                                        <thead class="thead">
                                                            <tr>
                                                                <th>
                                                                    <div class="custom-control custom-checkbox">
    ...
    @section('scripts')
        <script>
            var listRoute = "{{ Route('admin.shipper_advice') }}";
            var sessionType = "{{ session('type') }}";
        </script>
        <script src="{{ asset('assets/js/shipper_advice/shipper_advice.js') }}"></script>
    @endsection
@endsection
