        ...
        <div class="app-content--inner">
            <div class="pb-4 text-center text-xl-left">
                <div class="row align-items-center">
                    ...
                    <div class="mx-auto mx-xl-0  btn-wrapper" style="margin-right: 15px !important;">
                            <a class="btn btn-secondary-orio" href="{{ Route('admin.add_edit_de_manifist') }}">Add
                                {{ ucfirst($title) }}</a>
                        </div>
            ...
            <script>
                var listRoute = "{{ Route('admin.de-manifist') }}";
