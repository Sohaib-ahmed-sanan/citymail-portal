...
@section('content')
                                    ...
                                    <div class="col-md-10 mb-3 px-3">
                                        @if (is_ops())
                                            <select required
                                                ...
                                                id="customer_id" multiple data-toggle="select2" name="customer_acno[]"
                                        ...
                                        @else
                                            <input type="hidden" id="customer_id" name="customer_acno[]"
                                                value="{{ session('acno') }}">
                                        @endif
                                        @if (is_portal())
                                            @if (count($sub_acc) > 0)
    ...
    <script>
        var listRoute = "{{ route('admin.customer_reports') }}";
        var type = 'customer_report';
        var sessionType = "{{ session('type') }}";
    </script>

@section('scripts')
    <script src="{{ asset('assets/js/reports/customer_service.js') }}"></script>
@endsection
@endsection
