...
@section('content')
    ...
    <div class="app-content">
        <div class="app-content--inner">
            <div class="pb-4 text-center text-xl-left">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                        @if (is_ops())
                            <button data-toggle="tooltip" data-title="Filter" class="btn btn-sm btn-custom mr-2" data-toggle="modal" data-target="#filter_modal"><svg
                            ...
                            <a class="btn btn-secondary-orio mr-2" href="{{ Route('ops.add_invoice') }}">Add {{ ucfirst($title) }}</a>
                        @endif
            ...
            <script>
                var listRoute = "{{ route('ops.invoice') }}";
                var searchUrl = "";
                var storeUrl = "";
            </script>
        @section('scripts')
