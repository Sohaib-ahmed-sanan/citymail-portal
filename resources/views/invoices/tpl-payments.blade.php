...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center mt-1">
                            <div class="d-flex justify-content-center w-100">
                                <button type="button" class="btn btn-orio my-3" onclick="upload_bulk_cn('import-tpl-payments')" id="import_btn">Import</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="app-content">
        <div class="app-content--inner">
            <div class="pb-4 text-center text-xl-left">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                        <div class="mx-auto mx-xl-0  btn-wrapper" style="margin-right: 5px !important;">
                            @if (is_ops())
                                <button class="btn btn-sm btn-custom" data-toggle="modal"
                                    data-target="#filter_modal"><svg data-toggle="tooltip" data-title="Filter" class="w-20" width="28" height="26"
            ...
            <script>
                var listRoute = "{{ route('ops.tpl_payments') }}";
                var searchUrl = "";
                var storeUrl = "";
            </script>
        @section('scripts')
            <script src="{{ asset('assets/js/Invoices/TPL-Payments.js') }}"></script>
        @endsection
