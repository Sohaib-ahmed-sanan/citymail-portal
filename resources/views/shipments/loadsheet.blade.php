...
@section('content')
                        ...
                        <div class="col-md-12">
                            <form id="filter_form" method="post">
                                <div class="row" data-select2-id="6">
                                    @if (is_portal())
                                        <div class="col-md-12" data-select2-id="26">
                                            <select
                                                class="form-control form-select sub_account form-control-lg input_field "
                                                id="sub_account" multiple data-toggle="select2" name="sub_account"
    ...
    <div class="app-content">
        <div class="app-content--inner">
            ...
            <script>
                var listRoute = "{{ Route('admin.loadSheeet') }}";
            </script>
        @section('scripts')
            <script src="{{ asset('assets/js/loadsheet/loadsheet.js') }}"></script>
        @endsection
