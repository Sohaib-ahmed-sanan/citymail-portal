    ...
    <div class="app-content">
            ...
            <div class="modal-dialog modal-dialog-centered w-800" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h6 class="modal-title" id="modal-title-default">Edit Routes</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center mt-1">
                                <div class="d-flex justify-content-center w-100">
                                    ...
                                    <a href="javascript:;" class="btn btn-orio my-3" id="updateBtn">Edit Route</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="add_modal" role="dialog" aria-labelledby="editsucessModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered w-800" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h6 class="modal-title" id="modal-title-default">Add Routes</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">
                                <svg viewBox="0 0 24 24" width="26" height="26" stroke="currentColor"
                                    stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="add_route_from" method="POST" enctype="multipart/form-data"
                                    ...
                                    <input type="hidden" id="add_url" value="{{ route('admin.add_edit_route') }}">
                                </form>
                            </div>
                            <div class="col-md-12 text-center mt-1">
                                <div class="d-flex justify-content-center w-100">
                                    ...
                                    <button type="button" class="btn btn-secondary-orio mr-3 my-3" data-dismiss="modal"
                                        aria-label="Close">Close</button>
                                    <a href="javascript:;" class="btn btn-orio my-3" data-form-id="add_route_from"
                                        id="add-btn">Add Route</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                        <div class="mx-auto mx-xl-0  btn-wrapper" style="margin-right: 16px !important;">
                            <button class="btn btn-secondary-orio" data-toggle="modal" data-target="#add_modal">Add Routes</button>
                        </div>
