...
$(document).ready(function () {
    ...
    $('#apply_filters').click(function () {
        param.customer_acno = $("#customer").val();
        param.destination_id = $("#destination_id").val();
        param.status_id = $("#status_id").val();
        param.sub_acc = $("#sub_acc").val();

        if ((param.customer_acno == '') && (param.destination_id == '') && (param.status_id == '')) {
    ...
    $("#resetFilter").click(function () {
        ...
        $('#sub_acc').val('').trigger('change');
        param.sub_acc = param.customer_acno = param.destination_id = '';
        param.value_type = "filter";
...
// // to remove the cn 
$(document).on('click', '.cancle_cn', function () {

    var cn_no = $(this).data('cn_no');
    swal.fire({
        title: 'Confirmation',
        text: 'Are you sure you cancel this shipment?',
        type: "question",
        buttonsStyling: !1,
        ...
        t.value && $.ajax({
            url: BASEURL + 'cancle-consignment',
            type: "POST",
            data: {
                cn_no: cn_no
            },
