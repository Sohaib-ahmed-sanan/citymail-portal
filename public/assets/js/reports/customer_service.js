let datalist = (params) => {
    ...
    if (['1', '2', '3', '4','5','9'].includes(sessionType)) {
        ...
        aoColumns.splice(2, 0, { data: "TPL", visible: false });
...
$(document).ready(function () {
    ...
    var param = {
        ...
        customer_acno: $("#customer_id").val(),

        destination_id: $("#destination_id").val(),

        status_id: $("#status_id").val(),

        sub_acc: $("#sub_acc_id").val(),
