...
$(document).ready(function () {
    ...
    $('#apply_filters').click(function () {
        ...
        param.sub_acc_id = $("#sub_acc_id").val();

        if ((param.customer_id == '') && (param.destination_id == '') && (param.status_id == '')) {
    ...
    $("#resetFilter").click(function () {
        ...
        param.customer_id = param.destination_id = '';
        param.value_type = "filter";
