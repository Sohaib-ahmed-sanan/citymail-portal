...
$(document).ready(function () {
    ...
    $('#apply_filters').click(function () {
        ...
        if ((param.customer_acno == '') && (param.status_id == '')) {
            ...
            datalist(param);
            // destroyLoader('apply_filters', text, 'btn btn-secondary-orio');
        }
    });
    ...
    $("#resetFilter").click(function () {
        ...
        param.customer_acno = param.destination_id = '';
        param.value_type = "filter";
...
$(document).on('click', '.check_box', function () {
    ...
    if ($(this).prop('checked')) {
        ...
        // $('#append_btn_div').removeClass('d-none').slideUp();
    } else {
        // $('#append_btn_div').addClass('d-none').slideDown();
