let append_select = (country_id="") => {
    var optons = '';
    countries_array.map(function(v){
        optons += `<option value="${v.id}" ${(country_id == v.id ? 'selected' : '' )}>${ v.country_name }</option>`;
    });
    $('.applyall').html(`<div class="col-6 mt-2">
    ...
    $("#example").DataTable({
        ...
        drawCallback: function (settings) {
            ...
            if (value_type == 'filter' && response != undefined) {
                ...
                var btn_class = getSpinnerType[0] == 'resetFilter' ? 'btn-secondary-orio' : 'btn-orio';
