...
var optionDonut_5 = {
    ...
    donut_5 = new ApexCharts(document.querySelector("#donut_5"), optionDonut_5);
...
var mobileDonut_5 = function() {
    $(window).width() < 768 ? donut_5.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
