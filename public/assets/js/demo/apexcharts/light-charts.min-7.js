...
var optionDonut_7 = {
    ...
    donut_7 = new ApexCharts(document.querySelector("#donut_7"), optionDonut_7);
...
var mobileDonut_7 = function() {
    $(window).width() < 768 ? donut_7.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
