...
var optionDonut_8 = {
    ...
    donut_8 = new ApexCharts(document.querySelector("#donut_8"), optionDonut_8);
...
var mobileDonut_8 = function() {
    $(window).width() < 768 ? donut_8.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
