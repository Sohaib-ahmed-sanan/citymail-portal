...
var optionDonut_4 = {
    ...
    donut_4 = new ApexCharts(document.querySelector("#donut_4"), optionDonut_4);
...
var mobileDonut_4 = function() {
    $(window).width() < 768 ? donut_4.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
