...
var optionDonut = {
        ...
        colors: colorPalette,
        series: [22, 17, 19, 33, 13, 8, 15, 36, 20],
        labels: ["New", "1st Call", "2nd call", "3rd call", "On Hold", "RTS", "Cancelled ", "confirmed" , "Shipped"],
        legend: {
            position: "bottom"
        }
    },
    donut = new ApexCharts(document.querySelector("#donut"), optionDonut);
...
var mobileDonut = function() {
    $(window).width() < 768 ? donut.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
