...
var colorPalette = ['#2f2f7e','#f83245',  '#f4772e', '#f83245', '#11c5db']
...
var donut_2 = new ApexCharts(
    document.querySelector("#donut_2"),
    optionDonut_2
)
donut_2.render();
...
// on smaller screen, change the legends position for donut_2
var mobileDonut_2 = function() {
    if($(window).width() < 768) {
        donut_2.updateOptions({
            plotOptions: {
                pie: {
