...
var optionDonut_3 = {
    ...
    donut_3 = new ApexCharts(document.querySelector("#donut_3"), optionDonut_3);
...
var mobileDonut_3 = function() {
    $(window).width() < 768 ? donut_3.updateOptions({
        plotOptions: {
            pie: {}
        },
        legend: {
